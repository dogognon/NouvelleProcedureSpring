...
public class EntityScanPackages__BeanDefinitions {
  ...
  public static BeanDefinition getEntityScanPackagesBeanDefinition() {
    ...
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, new String[] {"com.dogognon.sohliou.kone.security.data", "com.dogognon.sohliou.kone.file.data", "com.dogognon.sohliou.kone.NouvelleProcedure", "org.springframework.data.jpa.convert.threeten"});
