...
public class JpaBaseConfiguration__BeanDefinitions {
  ...
  public static class PersistenceManagedTypesConfiguration {
    ...
    private static PersistenceManagedTypes getPersistenceManagedTypesInstance() {
      List<String> managedClassNames = List.of("com.dogognon.sohliou.kone.security.data.Role", "com.dogognon.sohliou.kone.security.data.User", "com.dogognon.sohliou.kone.file.data.File", "com.dogognon.sohliou.kone.NouvelleProcedure.data.Departement", "com.dogognon.sohliou.kone.NouvelleProcedure.data.Poste", "com.dogognon.sohliou.kone.NouvelleProcedure.data.Procedure", "com.dogognon.sohliou.kone.NouvelleProcedure.data.Services", "org.springframework.data.jpa.convert.threeten.Jsr310JpaConverters$LocalDateConverter", "org.springframework.data.jpa.convert.threeten.Jsr310JpaConverters$LocalTimeConverter", "org.springframework.data.jpa.convert.threeten.Jsr310JpaConverters$ZoneIdConverter", "org.springframework.data.jpa.convert.threeten.Jsr310JpaConverters$LocalDateTimeConverter", "org.springframework.data.jpa.convert.threeten.Jsr310JpaConverters$InstantConverter");
      List<String> managedPackages = List.of("org.springframework.data.jpa.convert.threeten");
