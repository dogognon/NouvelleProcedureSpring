...
public class RepositoryComposition__BeanDefinitions {
  ...
  public static class RepositoryFragments {
    /**
     * Get the bean instance supplier for 'jpa.ProcedureRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.FileRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.DepartementRepository.fragments#0'.
     */
    ...
    /**
     * Get the bean instance supplier for 'jpa.PosteRepository.fragments#0'.
     */
