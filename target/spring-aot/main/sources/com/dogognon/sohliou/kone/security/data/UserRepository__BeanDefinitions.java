...
public class UserRepository__BeanDefinitions {
  ...
  public static BeanDefinition getUserRepositoryBeanDefinition() {
    ...
    beanDefinition.setTargetType(ResolvableType.forClassWithGenerics(JpaRepositoryFactoryBean.class, UserRepository.class, User.class, String.class));
    beanDefinition.setLazyInit(false);
    beanDefinition.getConstructorArgumentValues().addIndexedArgumentValue(0, "com.dogognon.sohliou.kone.security.data.UserRepository");
