...
public class PrePostMethodSecurityConfiguration__BeanDefinitions {
  ...
  private static BeanInstanceSupplier<MethodInterceptor> getPreFilterAuthorizationMethodInterceptorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MethodInterceptor>forFactoryMethod(PrePostMethodSecurityConfiguration.class, "preFilterAuthorizationMethodInterceptor", ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, PrePostMethodSecurityConfiguration.class, ApplicationContext.class)
            .withGenerator((registeredBean, args) -> PrePostMethodSecurityConfiguration.preFilterAuthorizationMethodInterceptor(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6)));
  }
  ...
  private static BeanInstanceSupplier<MethodInterceptor> getPreAuthorizeAuthorizationMethodInterceptorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MethodInterceptor>forFactoryMethod(PrePostMethodSecurityConfiguration.class, "preAuthorizeAuthorizationMethodInterceptor", ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, PrePostMethodSecurityConfiguration.class, ApplicationContext.class)
            .withGenerator((registeredBean, args) -> PrePostMethodSecurityConfiguration.preAuthorizeAuthorizationMethodInterceptor(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6), args.get(7), args.get(8)));
  }
  ...
  private static BeanInstanceSupplier<MethodInterceptor> getPostAuthorizeAuthorizationMethodInterceptorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MethodInterceptor>forFactoryMethod(PrePostMethodSecurityConfiguration.class, "postAuthorizeAuthorizationMethodInterceptor", ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, PrePostMethodSecurityConfiguration.class, ApplicationContext.class)
            .withGenerator((registeredBean, args) -> PrePostMethodSecurityConfiguration.postAuthorizeAuthorizationMethodInterceptor(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6), args.get(7), args.get(8)));
  }
  ...
  private static BeanInstanceSupplier<MethodInterceptor> getPostFilterAuthorizationMethodInterceptorInstanceSupplier(
    ...
    return BeanInstanceSupplier.<MethodInterceptor>forFactoryMethod(PrePostMethodSecurityConfiguration.class, "postFilterAuthorizationMethodInterceptor", ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, ObjectProvider.class, PrePostMethodSecurityConfiguration.class, ApplicationContext.class)
            .withGenerator((registeredBean, args) -> PrePostMethodSecurityConfiguration.postFilterAuthorizationMethodInterceptor(args.get(0), args.get(1), args.get(2), args.get(3), args.get(4), args.get(5), args.get(6)));
  }
